  ...
  def create
    ...
    respond_to do |format|
      if @shipping_address.save
        format.html { redirect_to(@shipping_address, :notice => 'ShippingAddress was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @shipping_address.update_attributes(params[:shipping_address])
        format.html { redirect_to(@shipping_address, :notice => 'ShippingAddress was successfully updated.') }
        format.xml  { head :ok }
      else
